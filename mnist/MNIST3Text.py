# -*- coding: utf-8 -*-
"""
Created on Fri Mar 18 10:03:11 2022

@author: Xinnze
"""
# =============================================================================
# 进行学习率衰减操作与改变最小批次操作,将准确率从0.83提高到0.91
# =============================================================================
...
add_global = global_step.assign_add(1)  # 令global_step完成加1计步
initial_learning_rate = 0.15 # 定义参数
...
# 训练模型并输出中间状态参数
training_epochs = 25
batch_size = 80  # 在训练过程中一次取100条进行训练
display_step = 1
